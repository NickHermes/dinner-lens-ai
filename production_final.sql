-- ============================================
-- COMPLETE PRODUCTION SQL - CLEANUP + DEPLOYMENT
-- ============================================
-- This file cleans up existing functions and deploys all new ones
-- Run this entire file in your Supabase SQL Editor (production environment)

-- ============================================
-- 1. CLEANUP EXISTING FUNCTIONS
-- ============================================

-- Drop all existing versions of get_dish_of_day
DROP FUNCTION IF EXISTS public.get_dish_of_day(date, integer);
DROP FUNCTION IF EXISTS public.get_dish_of_day(date, integer, integer);
DROP FUNCTION IF EXISTS public.get_dish_of_day(date, integer, integer, integer);
DROP FUNCTION IF EXISTS public.get_dish_of_day(date, integer, integer, integer, text);
DROP FUNCTION IF EXISTS public.get_dish_of_day(date, integer, integer, integer, text, integer);
DROP FUNCTION IF EXISTS public.get_dish_of_day(date, integer, integer, integer, text, integer, text);

-- Drop all other existing functions
...
-- Clean up any remaining get_dish_of_day variations
DO $$ 
DECLARE 
    r RECORD;
BEGIN
